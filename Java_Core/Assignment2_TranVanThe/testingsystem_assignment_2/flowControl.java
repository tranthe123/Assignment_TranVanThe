...
public class flowControl {
	public static void main(String[] args) {
		...
		// Question 7:
		String acc = account1.position.name;
		switch (acc) {
		case "Dev":
